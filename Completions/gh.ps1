...
# Content below is the output of "gh completion -s powershell"
#   but that doesn't seem to be working if saved as text
#   and sourced like a typical completion. Instead the
#   gh cli website recommends invoking the following
#   command instead (from your profile script):
#
# ❯ Invoke-Expression -Command $(gh completion -s powershell | Out-String)
#
# So let's give that a try and see if it works any better...
# 
# Invoke-Expression -Command $(gh completion -s powershell | Out-String)
#
# It doesnt. According to https://github.com/cli/cli/issues/1775 this 
# is a known issue, the recommended approach from a commenter there 
# recommends this command which downloads an improved version of 
# the completions as a gist and applies that, so what the hell!
